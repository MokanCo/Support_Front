                      ...
                      {method.type === "zelle" ? (
                        <div className="mt-3 space-y-3 rounded-lg border border-teal-100 bg-teal-50/50 p-3">
                          <p className="text-xs font-medium text-teal-800">
                            Official Zelle details shown on the public invoice payment page (not a
                            link to our site). Upload/host your bank&apos;s Zelle QR and paste the
                            image URL below.
                          </p>
                          <Input
                            ...
                            onChange={(e) =>
                              updatePaymentMethod(index, { displayName: e.target.value })
                            }
                            placeholder="Mokanco Payments"
                          />
                          ...
                          <Input
                            label="Official Zelle QR code image URL"
                            value={method.qrCodeUrl}
                            onChange={(e) =>
                              updatePaymentMethod(index, { qrCodeUrl: e.target.value })
                            }
                            placeholder="https://… (your bank-generated Zelle QR)"
                          />
                          {method.qrCodeUrl ? (
                            // eslint-disable-next-line @next/next/no-img-element
                            <img
                              src={method.qrCodeUrl}
                              alt="Zelle QR preview"
